...
public static void searchContent(String value) {
	...
	public static void CourseUnderMyLearningSection(String coursename) throws Exception {
	    ...
	    DikshaUtils.waitToBeClickableAndClick(content.getHeaderDropdown());
	    DikshaUtils.waitToBeClickableAndClick(filter.getProfile());
       Thread.sleep(1000);
       JavascriptExecutor js=(JavascriptExecutor)driver;
	   js.executeScript("window.scrollBy(0, 1000)");
	   Thread.sleep(1000);
	   DikshaUtils.waitToBeClickableAndClick(filter.getViewMore());
	...
	public static void VerifyCourseUnderRecentlyPublishedCourse(String coursename) throws Exception {
	    ...
	    Thread.sleep(1000);
	    DikshaUtils.waitToBeClickableAndClick(home.getCourseTab());
	    Thread.sleep(1000);
	   ...
	   Thread.sleep(3000);
	   DikshaUtils.waitToBeClickableAndClick(filter.getViewAllButton());
	   Thread.sleep(1000);
	    String dynamicValue = coursename;
	...
	public static void verifyUserSeeNotificationInBellIcon() throws Exception {
		...
		try {
			...
			DikshaUtils.waitToBeClickableAndClick(notify.getBellIcon());
...
UserNotification notify = PageFactory.initElements(driver, UserNotification.class);
		...
		DikshaUtils.waitToBeClickableAndClick(notify.getSeeMoreButton());
		JavascriptExecutor js = (JavascriptExecutor) driver;
	...
	public static void verifyUserAbleToDeleteNotification() throws Exception {
		...
		try {
			...
			DikshaUtils.waitToBeClickableAndClick(notify.getBellIcon());
			Assert.assertTrue(notify.getNewNotificationsText().isDisplayed());
			DikshaUtils.waitToBeClickableAndClick(notify.getDeleteNotificationIcon());
	...
	public static void verifyUserAbleToClearAllNotification() throws Exception {
		...
		DikshaUtils.waitToBeClickableAndClick(notify.getClearNotificationButton());
	...
	public static void verifySeeLessOptionInNotification() throws Exception {
		...
		DikshaUtils.waitToBeClickableAndClick(notify.getSeeLessButton());
	...
	public static void VerifyLearnerPassbookSection() throws Exception {
		...
		try {
		Thread.sleep(1000);
		DikshaUtils.waitToBeClickableAndClick(usp.headerDropdown());
		DikshaUtils.waitToBeClickableAndClick(usp.getProfilebutton());
		JavascriptExecutor js = (JavascriptExecutor) driver;
