...
public class ValidateCertificateNameEditPopup extends BaseClass{

	@Test
	public void VerifyCertificateNameEditPopup() throws Exception {
		...
		Course_Consumption.verifyCertificateNameEditPopup(course);
