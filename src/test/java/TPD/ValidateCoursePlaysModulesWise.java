...
public class ValidateCoursePlaysModulesWise extends BaseClass {

	@Test
	public void verifyCoursePlaysModulesWise() throws Exception {
		...
		Course_Consumption.verifyCoursePlaysModulesWise(course);
