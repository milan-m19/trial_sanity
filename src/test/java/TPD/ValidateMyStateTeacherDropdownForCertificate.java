...
public class ValidateMyStateTeacherDropdownForCertificate extends BaseClass {
	@Test
	public void VerifyMyStateTeacherDropdownForCertificate() throws Exception {
		...
		CertificateCreation.VerifyMyStateTeacherDropdownForCertificate();
