...
public class ValidateGreenTickAfterConsumption extends BaseClass {
	@Test
	public void VerifyGreenTickAfterConsumption() throws Exception {
		...
		Course_Consumption.verifyGreenTick(course);
}
}