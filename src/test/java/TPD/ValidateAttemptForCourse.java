...
public class ValidateAttemptForCourse extends BaseClass {

	@Test
	public void VerifyAttemptForCourse() throws Exception {
		...
		Course_Consumption.verifyNumberOfAttempts(course);
