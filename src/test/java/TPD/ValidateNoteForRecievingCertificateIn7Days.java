...
public class ValidateNoteForRecievingCertificateIn7Days extends BaseClass{

	@Test
	public void VerifyNoteForRecievingCertificateIn7Days() throws Exception {
		...
		Course_Consumption.consumeCourseAndValidateRecieveCetificateNote(course);
