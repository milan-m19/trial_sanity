...
public class verifyAnonymousUserIsDisplayedPopUpMsg extends BaseClass {
	@Test
	public static void verifyAnonymousUserIsDisplayPopUpMsg() throws Exception {
		...
		UserOnBoarding.logout();
		TPDMethods.verifyAnonymousUserIsDisplayPopUpMessage(course, "Public User1");
