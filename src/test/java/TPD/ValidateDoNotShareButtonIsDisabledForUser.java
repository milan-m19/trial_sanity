...
public class ValidateDoNotShareButtonIsDisabledForUser extends BaseClass{
	
	@Test
	public void VerifyDoNotShareButtonIsDisabledForUser() throws Exception {
		...
		Course_Consumption.verifyDoNotShareButtonForConsentPopUp(course);
