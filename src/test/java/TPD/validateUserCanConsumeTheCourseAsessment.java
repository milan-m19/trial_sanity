...
public class validateUserCanConsumeTheCourseAsessment extends BaseClass {
	@Test
	public void verifyUserCanConsumeTheCourseAsessment() throws Exception {
	...
	Course_Consumption.VerifyDescriptionAndConsumeCourseAssesment(course);
