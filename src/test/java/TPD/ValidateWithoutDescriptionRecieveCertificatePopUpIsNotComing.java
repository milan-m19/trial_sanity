...
public class ValidateWithoutDescriptionRecieveCertificatePopUpIsNotComing extends BaseClass {

	@Test
	public void VerifyWithoutDescriptionRecieveCertificatePopUpIsNotComing() throws Exception {
		...
		String course=Course_Creation.courseWithoutDescription(contentName);
