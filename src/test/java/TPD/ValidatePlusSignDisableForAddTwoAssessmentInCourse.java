...
public class ValidatePlusSignDisableForAddTwoAssessmentInCourse extends BaseClass {

	@Test
	public void VerifyPlusSignDisableForTwoAssessment() throws Exception {
		...
		CertificateCreation.verifyDisablePlusSignToCertificate();
