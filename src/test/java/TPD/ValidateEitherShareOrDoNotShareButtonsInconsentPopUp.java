...
public class ValidateEitherShareOrDoNotShareButtonsInconsentPopUp extends BaseClass{
	@Test
	public void verifyEitherShareOrDoNotShareButtonsInconsentPopUp() throws Exception {
		...
		Course_Consumption.verifyEitherShareOrDoNotShareButtonsInconsentPopUp(course);
