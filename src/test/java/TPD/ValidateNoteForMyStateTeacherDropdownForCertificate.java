...
public class ValidateNoteForMyStateTeacherDropdownForCertificate extends BaseClass {
	@Test
	public void VerifyNoteForMyStateTeacherDropdownForCertificate() throws Exception {
		...
		CertificateCreation.VerifyNoteForStateTeacherDropdownForCertificate();
