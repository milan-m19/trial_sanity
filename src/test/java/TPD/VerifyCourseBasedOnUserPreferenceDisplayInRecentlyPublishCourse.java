...
public class VerifyCourseBasedOnUserPreferenceDisplayInRecentlyPublishCourse extends BaseClass{

	@Test
	public void verifyCourseBasedOnUserPreference() throws Exception {
...
//		UserOnBoarding.login("Creator");
		...
		AllMyContentMethods.VerifyCourseUnderRecentlyPublishedCourse(course);
