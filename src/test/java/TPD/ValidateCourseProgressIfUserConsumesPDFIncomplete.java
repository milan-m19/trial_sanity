...
public class ValidateCourseProgressIfUserConsumesPDFIncomplete extends BaseClass {
	@Test
	public void VerifyCourseProgressIfUserConsumesPDFIncomplete() throws Exception {
		...
		Course_Consumption.verifyCourseProgressIfUserConsumesPDFIncomplete(course);
