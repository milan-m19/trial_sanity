...
public class VerifyUserAbleToDownvotesToAnyPost extends BaseClass {

	@Test
	public void verifyUserAbleToDownvotesToAnyPost() throws Exception {
		...
		CreateGroups.UserAbleTODownvotesToThePost();
