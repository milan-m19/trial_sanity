...
public class ValidateCourseTocAndDetails extends BaseClass {
	@Test
	public void verifyCourseTocAndDetails() throws Exception {
		...
		TPDMethods.verifyCourseTocAndDetail(course);
