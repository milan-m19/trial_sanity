...
public class verifyUserSelectsTheOngoingFromMyCoursesAndUserSeeOngoingCourseBatchWithProgress extends BaseClass {
	@Test
	public static void verifyUserSelectsTheOngoingFromMyCoursesAndUserSeeOngoingCourseBatch() throws Exception {
		...
		TPDMethods.verifyUserSelectsOngoingFromMyCoursesAndUserSeeOngoingCourseBatch(course);
