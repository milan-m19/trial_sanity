...
public class VerifyUserAbleToTagToAnyTopic extends BaseClass {

	@Test
	public void verifyUserAbleToTagToAnyTopic() throws Exception {
		...
		CreateGroups.CreateDiscussionFormForGroup();
		CreateGroups.ValidateUserAbleToTagAnyTopic();
