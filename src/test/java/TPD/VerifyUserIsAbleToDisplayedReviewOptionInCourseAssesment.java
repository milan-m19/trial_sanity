...
public class VerifyUserIsAbleToDisplayedReviewOptionInCourseAssesment extends BaseClass{

	
	@Test
	public void verifyUserIsAbleToDisplayedReviewOption() throws Exception {
...
//		UserOnBoarding.login("Creator");
		...
		Course_Consumption.consumeCourseAssesmentAndVerifyReviewOption(course);
