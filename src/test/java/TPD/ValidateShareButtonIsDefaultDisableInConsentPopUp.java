...
public class ValidateShareButtonIsDefaultDisableInConsentPopUp extends BaseClass {

	@Test
	public void verifyShareButtonIsDefaultDisableInConsentPopUp() throws Exception {
		...
		Course_Consumption.verifyShareButtonIsDefaultDisableInConsentPopUp(course);
