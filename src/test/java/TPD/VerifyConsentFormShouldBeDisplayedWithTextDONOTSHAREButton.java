...
public class VerifyConsentFormShouldBeDisplayedWithTextDONOTSHAREButton extends BaseClass {

	
	@Test
	public void VerifyConsentFormShouldBeDisplayed() throws Exception {
...
//		UserOnBoarding.login("Creator");
		...
		TPDMethods.userEnrollsInCourseWithDoNotShareButton(course);
	}
