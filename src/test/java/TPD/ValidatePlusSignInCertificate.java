...
public class ValidatePlusSignInCertificate extends BaseClass {
	@Test
	public void VerifyPlusSignForCertificate() throws Exception {
		...
		CertificateCreation.verifyPlusSignToCertificate();
