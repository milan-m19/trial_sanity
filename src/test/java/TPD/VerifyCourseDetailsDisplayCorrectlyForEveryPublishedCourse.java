...
public class VerifyCourseDetailsDisplayCorrectlyForEveryPublishedCourse extends BaseClass{
	
	@Test
	public void verifyCourseDetailsDisplayCorrectlyForEveryPublishedCourse() throws Exception {
...
//		UserOnBoarding.login("Creator");
		...
		TPDMethods.ValidateCourseDetails(course);
