...
public class verifyUserSelectsTheOngoingFromMyProfileAndAbleToConsumeTheCourse extends BaseClass {
	@Test
	public void verifyUserSelectsTheOngoingFromMyProfileAndConsume() throws Exception {
		...
		Course_Consumption.verifyUserSelectsTheOngoingFromMyProfileAndConsume(course);
