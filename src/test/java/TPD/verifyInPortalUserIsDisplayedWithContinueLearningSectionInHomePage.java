...
public class verifyInPortalUserIsDisplayedWithContinueLearningSectionInHomePage extends BaseClass {
@Test
public void userInPortalUserIsDisplayedWithContinueLearningSectionInHomePage() throws Exception {
		...
		Course_Consumption.PartiallyConsumeAndNavigateToHmePage(course);	
	}
}