...
public class VerifyUserAbleToSeeMyDiscussion extends BaseClass {

	@Test
	public void verifyUserAbleToSeeMyDiscussion() throws Exception {
		...
		CreateGroups.UserAbleToSeeMyDiscussion();
