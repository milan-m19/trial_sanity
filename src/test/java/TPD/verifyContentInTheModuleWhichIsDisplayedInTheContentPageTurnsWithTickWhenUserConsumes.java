...
public class verifyContentInTheModuleWhichIsDisplayedInTheContentPageTurnsWithTickWhenUserConsumes extends BaseClass {
	@Test
	public static void verifyContentInTheModuleWhichIsDisplayedInTheContentPageTurnsWithTickWhenConsumes()
			throws Exception {
		...
		TPDMethods.verifyContentInTheModuleWhichIsDisplayedInTheContentPageTurnsWithTick();
	}
}
