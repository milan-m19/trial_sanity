...
public class ValidateConsentPopUpForMinorUser extends BaseClass {
	
	
	@Test
	public void validateConsentPopUpForMinorUserIsDisable() throws Exception {
		...
		Course_Consumption.verifyConsentPopUp(course);
