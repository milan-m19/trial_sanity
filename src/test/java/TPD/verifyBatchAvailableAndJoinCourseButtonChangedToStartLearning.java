...
public class verifyBatchAvailableAndJoinCourseButtonChangedToStartLearning extends BaseClass {
	@Test
	public static void verifyBatchAvailableAndJoinCourseButtonChangedToStartLearning() throws Exception {
		...
		TPDMethods.verifyBatchAndJoinCourseButtonChangedToStartLearning(course);
