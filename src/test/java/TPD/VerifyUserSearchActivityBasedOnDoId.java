...
public class VerifyUserSearchActivityBasedOnDoId extends BaseClass {

	
	@Test
	public void verifyUserSearchActivityBasedOnDoId() throws Exception {
...
//		UserOnBoarding.login("Creator");
		...
		String Doid= excel.getDoID("Course");
		CreateGroups.AdminSearchActivityBasedOnDoId(Doid);
