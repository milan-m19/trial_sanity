...
public class VerifyUserAbleToConsumeCoursePartiallyAndUnenrolledAndAgainEnrolled extends BaseClass {

	@Test
	public void verifyUserAbleToConsumeCoursePartiallyAndUnenrolled() throws Exception {
...
//		UserOnBoarding.login("Creator");
	...
	//	TPDMethods.UserNotAbleToSeeCourseInMyCourseSection(course);
		TPDMethods.userReEnrollInCourse(course);
		TPDMethods.UserAbleToSeeCourseInMyCourseSection(course);
	}
}
